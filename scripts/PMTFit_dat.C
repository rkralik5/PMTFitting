...
#define fResolution 16384 ///< Number of ADC bins (=2^ADCResolution)
...
#define fWindowSize 1030 ///< Size of the waveform (number of time bins)

// Values to estimate the initial shape of the pedestal
float fThreshold = 0.5; ///< Threshold for pedestal in mV (not used in fit)
int fPeakTime = 600; ///< Approx. time of the peak in ns (not used in fit)
